...
class funcCommon {
    ...
    public static Vec2 clamp_(Vec2 v, float minVal, float maxVal) {
        return clamp(v, minVal, maxVal, new Vec2());
    }

    public static Vec2 clamp(Vec2 v, float minVal, float maxVal, Vec2 result) {
        return v.clamp(minVal, maxVal, result);
    }
