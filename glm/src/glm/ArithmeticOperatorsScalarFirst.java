 ...
 * @author GBarbieri
 */
abstract class ArithmeticOperatorsScalarFirst extends ArithmeticOperators {

    public static Vec2 add_(float a, Vec2 b) {
        return ArithmeticOperators.add(new Vec2(), b, a, a);
    }

    public static Vec2 add(float a, Vec2 b) {
        return ArithmeticOperators.add(b, b, a, a);
    }

    public static Vec2 add(Vec2 res, float a, Vec2 b) {
        return ArithmeticOperators.add(res, b, a, a);
    }

    public static Vec2 add(Vec2 res, float aX, float aY, Vec2 b) {
        return ArithmeticOperators.add(res, b, aX, aY);
    }

    public static Vec2b add_(byte a, Vec2b b) {
        return ArithmeticOperators.add(new Vec2b(), b, (int) a, a);
    }

    public static Vec2b add_(int a, Vec2b b) {
        return ArithmeticOperators.add(new Vec2b(), b, a, a);
    }

    public static Vec2b add(byte a, Vec2b b) {
        return ArithmeticOperators.add(b, b, (int) a, a);
    }
    ...
    public static Vec2b add(Vec2b res, byte a, Vec2b b) {
        return ArithmeticOperators.add(res, b, (int) a, a);
    }
    ...
    public static Vec2b add(Vec2b res, byte aX, byte aY, Vec2b b) {
        return ArithmeticOperators.add(res, b, (int) aX, aY);
    }
    ...
    public static Vec2d add_(double a, Vec2d b) {
        return ArithmeticOperators.add(new Vec2d(), b, a, a);
    }
    ...
    public static Vec2i add_(int a, Vec2i b) {
        return ArithmeticOperators.add(new Vec2i(), b, a, a);
    }
    ...
    public static Vec2l add_(long a, Vec2l b) {
        return ArithmeticOperators.add(new Vec2l(), b, a, a);
    }
    ...
    public static Vec2s add_(short a, Vec2s b) {
        return ArithmeticOperators.add(new Vec2s(), b, a, a);
    }
    ...
    public static Vec2ub add_(UByte a, Vec2ub b) {
        return ArithmeticOperators.add(new Vec2ub(), b, (int) a.value, a.value);
    }

    public static Vec2ub add_(byte a, Vec2ub b) {
        return ArithmeticOperators.add(new Vec2ub(), b, (int) a, a);
    }

    public static Vec2ub add_(int a, Vec2ub b) {
        return ArithmeticOperators.add(new Vec2ub(), b, a & 0xff, a & 0xff);
    }

    public static Vec2ub add(UByte a, Vec2ub b) {
        return ArithmeticOperators.add(b, b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub add(byte a, Vec2ub b) {
        return ArithmeticOperators.add(b, b, a & 0xff, a & 0xff);
    }
    ...
    public static Vec2ub add(Vec2ub res, UByte a, Vec2ub b) {
        return ArithmeticOperators.add(res, b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub add(Vec2ub res, byte a, Vec2ub b) {
        return ArithmeticOperators.add(res, b, a & 0xff, a & 0xff);
    }
    ...
    public static Vec2ub add(Vec2ub res, UByte aX, UByte aY, Vec2ub b) {
        return ArithmeticOperators.add(res, b, aX.value & 0xff, aY.value & 0xff);
    }

    public static Vec2ub add(Vec2ub res, byte aX, byte aY, Vec2ub b) {
        return ArithmeticOperators.add(res, b, aX & 0xff, aY & 0xff);
    }
    ...
    public static Vec2ui add_(UInt a, Vec2ui b) {
        return ArithmeticOperators.add(new Vec2ui(), b, a.value, a.value);
    }

    public static Vec2ui add_(int a, Vec2ui b) {
        return ArithmeticOperators.add(new Vec2ui(), b, a, a);
    }

    public static Vec2ui add(UInt a, Vec2ui b) {
        return ArithmeticOperators.add(b, b, a.value, a.value);
    }
    ...
    public static Vec2ui add(Vec2ui res, UInt a, Vec2ui b) {
        return ArithmeticOperators.add(res, b, a.value, a.value);
    }
    ...
    public static Vec2ui add(Vec2ui res, UInt aX, UInt aY, Vec2ui b) {
        return ArithmeticOperators.add(res, b, aX.value, aY.value);
    }
    ...
    public static Vec2ul add_(ULong a, Vec2ul b) {
        return ArithmeticOperators.add(new Vec2ul(), b, a.value, a.value);
    }

    public static Vec2ul add_(long a, Vec2ul b) {
        return ArithmeticOperators.add(new Vec2ul(), b, a, a);
    }
    ...
    public static Vec2us add_(UShort a, Vec2us b) {
        return ArithmeticOperators.add(new Vec2us(), b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us add_(short a, Vec2us b) {
        return ArithmeticOperators.add(new Vec2us(), b, a & 0xffff, a & 0xffff);
    }

    public static Vec2us add_(int a, Vec2us b) {
        return ArithmeticOperators.add(new Vec2us(), b, a, a);
    }

    public static Vec2us add(UShort a, Vec2us b) {
        return ArithmeticOperators.add(b, b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us add(short a, Vec2us b) {
        return ArithmeticOperators.add(b, b, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec2us add(Vec2us res, UShort a, Vec2us b) {
        return ArithmeticOperators.add(res, b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us add(Vec2us res, short a, Vec2us b) {
        return ArithmeticOperators.add(res, b, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec2us add(Vec2us res, UShort aX, UShort aY, Vec2us b) {
        return ArithmeticOperators.add(res, b, aX.value & 0xffff, aY.value & 0xffff);
    }

    public static Vec2us add(Vec2us res, short aX, short aY, Vec2us b) {
        return ArithmeticOperators.add(res, b, aX & 0xffff, aY & 0xffff);
    }
    ...
    public static Vec3 add_(float a, Vec3 b) {
        return ArithmeticOperators.add(new Vec3(), b, a, a, a);
    }

    public static Vec3 add(float a, Vec3 b) {
        return ArithmeticOperators.add(b, b, a, a, a);
    }

    public static Vec3 add(Vec3 res, float a, Vec3 b) {
        return ArithmeticOperators.add(res, b, a, a, a);
    }

    public static Vec3 add(Vec3 res, float aX, float aY, float aZ, Vec3 b) {
        return ArithmeticOperators.add(res, b, aX, aY, aZ);
    }

    public static Vec3b add_(byte a, Vec3b b) {
        return ArithmeticOperators.add(new Vec3b(), b, (int) a, a, a);
    }

    public static Vec3b add_(int a, Vec3b b) {
        return ArithmeticOperators.add(new Vec3b(), b, a, a, a);
    }

    public static Vec3b add(byte a, Vec3b b) {
        return ArithmeticOperators.add(b, b, (int) a, a, a);
    }
    ...
    public static Vec3b add(Vec3b res, byte a, Vec3b b) {
        return ArithmeticOperators.add(res, b, (int) a, a, a);
    }
    ...
    public static Vec3b add(Vec3b res, byte aX, byte aY, byte aZ, Vec3b b) {
        return ArithmeticOperators.add(res, b, (int) aX, aY, aZ);
    }
    ...
    public static Vec3d add_(double a, Vec3d b) {
        return ArithmeticOperators.add(new Vec3d(), b, a, a, a);
    }
    ...
    public static Vec3i add_(int a, Vec3i b) {
        return ArithmeticOperators.add(new Vec3i(), b, a, a, a);
    }
    ...
    public static Vec3l add_(long a, Vec3l b) {
        return ArithmeticOperators.add(new Vec3l(), b, a, a, a);
    }
    ...
    public static Vec3s add_(short a, Vec3s b) {
        return ArithmeticOperators.add(new Vec3s(), b, a, a, a);
    }
    ...
    public static Vec3ub add_(UByte a, Vec3ub b) {
        return ArithmeticOperators.add(new Vec3ub(), b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub add_(byte a, Vec3ub b) {
        return ArithmeticOperators.add(new Vec3ub(), b, a & 0xff, a & 0xff, a & 0xff);
    }

    public static Vec3ub add_(int a, Vec3ub b) {
        return ArithmeticOperators.add(new Vec3ub(), b, a, a, a);
    }

    public static Vec3ub add(UByte a, Vec3ub b) {
        return ArithmeticOperators.add(b, b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub add(byte a, Vec3ub b) {
        return ArithmeticOperators.add(b, b, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec3ub add(Vec3ub res, UByte a, Vec3ub b) {
        return ArithmeticOperators.add(res, b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub add(Vec3ub res, byte a, Vec3ub b) {
        return ArithmeticOperators.add(res, b, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec3ub add(Vec3ub res, UByte aX, UByte aY, UByte aZ, Vec3ub b) {
        return ArithmeticOperators.add(res, b, aX.value & 0xff, aY.value & 0xff, aZ.value & 0xff);
    }

    public static Vec3ub add(Vec3ub res, byte aX, byte aY, byte aZ, Vec3ub b) {
        return ArithmeticOperators.add(res, b, aX & 0xff, aY & 0xff, aZ & 0xff);
    }
    ...
    public static Vec3ui add_(UInt a, Vec3ui b) {
        return ArithmeticOperators.add(new Vec3ui(), b, a.value, a.value, a.value);
    }

    public static Vec3ui add_(int a, Vec3ui b) {
        return ArithmeticOperators.add(new Vec3ui(), b, a, a, a);
    }

    public static Vec3ui add(UInt a, Vec3ui b) {
        return ArithmeticOperators.add(b, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui add(Vec3ui res, UInt a, Vec3ui b) {
        return ArithmeticOperators.add(res, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui add(Vec3ui res, UInt aX, UInt aY, UInt aZ, Vec3ui b) {
        return ArithmeticOperators.add(res, b, aX.value, aY.value, aZ.value);
    }
    ...
    public static Vec3ul add_(ULong a, Vec3ul b) {
        return ArithmeticOperators.add(new Vec3ul(), b, a.value, a.value, a.value);
    }

    public static Vec3ul add_(long a, Vec3ul b) {
        return ArithmeticOperators.add(new Vec3ul(), b, a, a, a);
    }
    ...
    public static Vec3us add_(UShort a, Vec3us b) {
        return ArithmeticOperators.add(new Vec3us(), b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us add_(short a, Vec3us b) {
        return ArithmeticOperators.add(new Vec3us(), b, a & 0xffff, a & 0xffff, a & 0xffff);
    }

    public static Vec3us add_(int a, Vec3us b) {
        return ArithmeticOperators.add(new Vec3us(), b, a, a, a);
    }

    public static Vec3us add(UShort a, Vec3us b) {
        return ArithmeticOperators.add(b, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us add(short a, Vec3us b) {
        return ArithmeticOperators.add(b, b, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec3us add(Vec3us res, UShort a, Vec3us b) {
        return ArithmeticOperators.add(res, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us add(Vec3us res, short a, Vec3us b) {
        return ArithmeticOperators.add(res, b, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec3us add(Vec3us res, UShort aX, UShort aY, UShort aZ, Vec3us b) {
        return ArithmeticOperators.add(res, b, aX.value & 0xffff, aY.value & 0xffff, aZ.value & 0xffff);
    }

    public static Vec3us add(Vec3us res, short aX, short aY, short aZ, Vec3us b) {
        return ArithmeticOperators.add(res, b, aX & 0xffff, aY & 0xffff, aZ & 0xffff);
    }
    ...
    public static Vec4 add_(float a, Vec4 b) {
        return ArithmeticOperators.add(new Vec4(), b, a, a, a, a);
    }

    public static Vec4 add(float a, Vec4 b) {
        return ArithmeticOperators.add(b, b, a, a, a, a);
    }

    public static Vec4 add(Vec4 res, float a, Vec4 b) {
        return ArithmeticOperators.add(res, b, a, a, a, a);
    }

    public static Vec4 add(Vec4 res, float aX, float aY, float aZ, float aW, Vec4 b) {
        return ArithmeticOperators.add(res, b, aX, aY, aZ, aW);
    }

    public static Vec4b add_(byte a, Vec4b b) {
        return ArithmeticOperators.add(new Vec4b(), b, (int) a, a, a, a);
    }

    public static Vec4b add_(int a, Vec4b b) {
        return ArithmeticOperators.add(new Vec4b(), b, a, a, a, a);
    }

    public static Vec4b add(byte a, Vec4b b) {
        return ArithmeticOperators.add(b, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b add(Vec4b res, byte a, Vec4b b) {
        return ArithmeticOperators.add(res, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b add(Vec4b res, byte aX, byte aY, byte aZ, byte aW, Vec4b b) {
        return ArithmeticOperators.add(res, b, (int) aX, aY, aZ, aW);
    }
    ...
    public static Vec4d add_(double a, Vec4d b) {
        return ArithmeticOperators.add(new Vec4d(), b, a, a, a, a);
    }
    ...
    public static Vec4i add_(int a, Vec4i b) {
        return ArithmeticOperators.add(new Vec4i(), b, a, a, a, a);
    }
    ...
    public static Vec4l add_(long a, Vec4l b) {
        return ArithmeticOperators.add(new Vec4l(), b, a, a, a, a);
    }
    ...
    public static Vec4s add_(short a, Vec4s b) {
        return ArithmeticOperators.add(new Vec4s(), b, a, a, a, a);
    }
    ...
    public static Vec4ub add_(UByte a, Vec4ub b) {
        return ArithmeticOperators.add(new Vec4ub(), b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub add_(byte a, Vec4ub b) {
        return ArithmeticOperators.add(new Vec4ub(), b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }

    public static Vec4ub add_(int a, Vec4ub b) {
        return ArithmeticOperators.add(new Vec4ub(), b, a, a, a, a);
    }

    public static Vec4ub add(UByte a, Vec4ub b) {
        return ArithmeticOperators.add(b, b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub add(byte a, Vec4ub b) {
        return ArithmeticOperators.add(b, b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec4ub add(Vec4ub res, UByte a, Vec4ub b) {
        return ArithmeticOperators.add(res, b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub add(Vec4ub res, byte a, Vec4ub b) {
        return ArithmeticOperators.add(res, b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec4ub add(Vec4ub res, UByte aX, UByte aY, UByte aZ, UByte aW, Vec4ub b) {
        return ArithmeticOperators.add(res, b, aX.value & 0xff, aY.value & 0xff, aZ.value & 0xff, aW.value & 0xff);
    }

    public static Vec4ub add(Vec4ub res, byte aX, byte aY, byte aZ, byte aW, Vec4ub b) {
        return ArithmeticOperators.add(res, b, aX & 0xff, aY & 0xff, aZ & 0xff, aW & 0xff);
    }
    ...
    public static Vec4ui add_(UInt a, Vec4ui b) {
        return ArithmeticOperators.add(new Vec4ui(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ui add_(int a, Vec4ui b) {
        return ArithmeticOperators.add(new Vec4ui(), b, a, a, a, a);
    }

    public static Vec4ui add(UInt a, Vec4ui b) {
        return ArithmeticOperators.add(b, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui add(Vec4ui res, UInt a, Vec4ui b) {
        return ArithmeticOperators.add(res, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui add(Vec4ui res, UInt aX, UInt aY, UInt aZ, UInt aW, Vec4ui b) {
        return ArithmeticOperators.add(res, b, aX.value, aY.value, aZ.value, aW.value);
    }
    ...
    public static Vec4ul add_(ULong a, Vec4ul b) {
        return ArithmeticOperators.add(new Vec4ul(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ul add_(long a, Vec4ul b) {
        return ArithmeticOperators.add(new Vec4ul(), b, a, a, a, a);
    }
    ...
    public static Vec4us add_(UShort a, Vec4us b) {
        return ArithmeticOperators.add(new Vec4us(), b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us add_(short a, Vec4us b) {
        return ArithmeticOperators.add(new Vec4us(), b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }

    public static Vec4us add_(int a, Vec4us b) {
        return ArithmeticOperators.add(new Vec4us(), b, a, a, a, a);
    }

    public static Vec4us add(UShort a, Vec4us b) {
        return ArithmeticOperators.add(b, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us add(short a, Vec4us b) {
        return ArithmeticOperators.add(b, b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec4us add(Vec4us res, UShort a, Vec4us b) {
        return ArithmeticOperators.add(res, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us add(Vec4us res, short a, Vec4us b) {
        return ArithmeticOperators.add(res, b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec4us add(Vec4us res, UShort aX, UShort aY, UShort aZ, UShort aW, Vec4us b) {
        return ArithmeticOperators.add(res, b, aX.value & 0xffff, aY.value & 0xffff, aZ.value & 0xffff, aW.value & 0xffff);
    }

    public static Vec4us add(Vec4us res, short aX, short aY, short aZ, short aW, Vec4us b) {
        return ArithmeticOperators.add(res, b, aX & 0xffff, aY & 0xffff, aZ & 0xffff, aW & 0xffff);
    }
    ...
    public static Vec2 sub_(float a, Vec2 b) {
        return ArithmeticOperators.sub(new Vec2(), b, a, a);
    }

    public static Vec2 sub(float a, Vec2 b) {
        return ArithmeticOperators.sub(b, b, a, a);
    }

    public static Vec2 sub(Vec2 res, float a, Vec2 b) {
        return ArithmeticOperators.sub(res, b, a, a);
    }

    public static Vec2 sub(Vec2 res, float aX, float aY, Vec2 b) {
        return ArithmeticOperators.sub(res, b, aX, aY);
    }

    public static Vec2b sub_(byte a, Vec2b b) {
        return ArithmeticOperators.sub(new Vec2b(), b, (int) a, a);
    }

    public static Vec2b sub_(int a, Vec2b b) {
        return ArithmeticOperators.sub(new Vec2b(), b, a, a);
    }

    public static Vec2b sub(byte a, Vec2b b) {
        return ArithmeticOperators.sub(b, b, (int) a, a);
    }
    ...
    public static Vec2b sub(Vec2b res, byte a, Vec2b b) {
        return ArithmeticOperators.sub(res, b, (int) a, a);
    }
    ...
    public static Vec2b sub(Vec2b res, byte aX, byte aY, Vec2b b) {
        return ArithmeticOperators.sub(res, b, (int) aX, aY);
    }
    ...
    public static Vec2d sub_(double a, Vec2d b) {
        return ArithmeticOperators.sub(new Vec2d(), b, a, a);
    }
    ...
    public static Vec2i sub_(int a, Vec2i b) {
        return ArithmeticOperators.sub(new Vec2i(), b, a, a);
    }
    ...
    public static Vec2l sub_(long a, Vec2l b) {
        return ArithmeticOperators.sub(new Vec2l(), b, a, a);
    }
    ...
    public static Vec2s sub_(short a, Vec2s b) {
        return ArithmeticOperators.sub(new Vec2s(), b, a, a);
    }
    ...
    public static Vec2ub sub_(UByte a, Vec2ub b) {
        return ArithmeticOperators.sub(new Vec2ub(), b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub sub_(byte a, Vec2ub b) {
        return ArithmeticOperators.sub(new Vec2ub(), b, a & 0xff, a & 0xff);
    }

    public static Vec2ub sub_(int a, Vec2ub b) {
        return ArithmeticOperators.sub(new Vec2ub(), b, a, a);
    }

    public static Vec2ub sub(UByte a, Vec2ub b) {
        return ArithmeticOperators.sub(b, b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub sub(byte a, Vec2ub b) {
        return ArithmeticOperators.sub(b, b, a & 0xff, a & 0xff);
    }
    ...
    public static Vec2ub sub(Vec2ub res, UByte a, Vec2ub b) {
        return ArithmeticOperators.sub(res, b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub sub(Vec2ub res, byte a, Vec2ub b) {
        return ArithmeticOperators.sub(res, b, a & 0xff, a & 0xff);
    }
    ...
    public static Vec2ub sub(Vec2ub res, UByte aX, UByte aY, Vec2ub b) {
        return ArithmeticOperators.sub(res, b, aX.value & 0xff, aY.value & 0xff);
    }

    public static Vec2ub sub(Vec2ub res, byte aX, byte aY, Vec2ub b) {
        return ArithmeticOperators.sub(res, b, aX & 0xff, aY & 0xff);
    }
    ...
    public static Vec2ui sub_(UInt a, Vec2ui b) {
        return ArithmeticOperators.sub(new Vec2ui(), b, a.value, a.value);
    }

    public static Vec2ui sub_(int a, Vec2ui b) {
        return ArithmeticOperators.sub(new Vec2ui(), b, a, a);
    }

    public static Vec2ui sub(UInt a, Vec2ui b) {
        return ArithmeticOperators.sub(b, b, a.value, a.value);
    }
    ...
    public static Vec2ui sub(Vec2ui res, UInt a, Vec2ui b) {
        return ArithmeticOperators.sub(res, b, a.value, a.value);
    }
    ...
    public static Vec2ui sub(Vec2ui res, UInt aX, UInt aY, Vec2ui b) {
        return ArithmeticOperators.sub(res, b, aX.value, aY.value);
    }
    ...
    public static Vec2ul sub_(ULong a, Vec2ul b) {
        return ArithmeticOperators.sub(new Vec2ul(), b, a.value, a.value);
    }

    public static Vec2ul sub_(long a, Vec2ul b) {
        return ArithmeticOperators.sub(new Vec2ul(), b, a, a);
    }
    ...
    public static Vec2us sub_(UShort a, Vec2us b) {
        return ArithmeticOperators.sub(new Vec2us(), b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us sub_(short a, Vec2us b) {
        return ArithmeticOperators.sub(new Vec2us(), b, a & 0xffff, a & 0xffff);
    }

    public static Vec2us sub_(int a, Vec2us b) {
        return ArithmeticOperators.sub(new Vec2us(), b, a, a);
    }

    public static Vec2us sub(UShort a, Vec2us b) {
        return ArithmeticOperators.sub(b, b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us sub(short a, Vec2us b) {
        return ArithmeticOperators.sub(b, b, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec2us sub(Vec2us res, UShort a, Vec2us b) {
        return ArithmeticOperators.sub(res, b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us sub(Vec2us res, short a, Vec2us b) {
        return ArithmeticOperators.sub(res, b, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec2us sub(Vec2us res, UShort aX, UShort aY, Vec2us b) {
        return ArithmeticOperators.sub(res, b, aX.value & 0xffff, aY.value & 0xffff);
    }

    public static Vec2us sub(Vec2us res, short aX, short aY, Vec2us b) {
        return ArithmeticOperators.sub(res, b, aX & 0xffff, aY & 0xffff);
    }
    ...
    public static Vec3 sub_(float a, Vec3 b) {
        return ArithmeticOperators.sub(new Vec3(), b, a, a, a);
    }

    public static Vec3 sub(float a, Vec3 b) {
        return ArithmeticOperators.sub(b, b, a, a, a);
    }

    public static Vec3 sub(Vec3 res, float a, Vec3 b) {
        return ArithmeticOperators.sub(res, b, a, a, a);
    }

    public static Vec3 sub(Vec3 res, float aX, float aY, float aZ, Vec3 b) {
        return ArithmeticOperators.sub(res, b, aX, aY, aZ);
    }

    public static Vec3b sub_(byte a, Vec3b b) {
        return ArithmeticOperators.sub(new Vec3b(), b, (int) a, a, a);
    }

    public static Vec3b sub_(int a, Vec3b b) {
        return ArithmeticOperators.sub(new Vec3b(), b, a, a, a);
    }

    public static Vec3b sub(byte a, Vec3b b) {
        return ArithmeticOperators.sub(b, b, (int) a, a, a);
    }
    ...
    public static Vec3b sub(Vec3b res, byte a, Vec3b b) {
        return ArithmeticOperators.sub(res, b, (int) a, a, a);
    }
    ...
    public static Vec3b sub(Vec3b res, byte aX, byte aY, byte aZ, Vec3b b) {
        return ArithmeticOperators.sub(res, b, (int) aX, aY, aZ);
    }
    ...
    public static Vec3d sub_(double a, Vec3d b) {
        return ArithmeticOperators.sub(new Vec3d(), b, a, a, a);
    }
    ...
    public static Vec3i sub_(int a, Vec3i b) {
        return ArithmeticOperators.sub(new Vec3i(), b, a, a, a);
    }
    ...
    public static Vec3l sub_(long a, Vec3l b) {
        return ArithmeticOperators.sub(new Vec3l(), b, a, a, a);
    }
    ...
    public static Vec3s sub_(short a, Vec3s b) {
        return ArithmeticOperators.sub(new Vec3s(), b, a, a, a);
    }
    ...
    public static Vec3ub sub_(UByte a, Vec3ub b) {
        return ArithmeticOperators.sub(new Vec3ub(), b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub sub_(byte a, Vec3ub b) {
        return ArithmeticOperators.sub(new Vec3ub(), b, a & 0xff, a & 0xff, a & 0xff);
    }

    public static Vec3ub sub_(int a, Vec3ub b) {
        return ArithmeticOperators.sub(new Vec3ub(), b, a, a, a);
    }

    public static Vec3ub sub(UByte a, Vec3ub b) {
        return ArithmeticOperators.sub(b, b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub sub(byte a, Vec3ub b) {
        return ArithmeticOperators.sub(b, b, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec3ub sub(Vec3ub res, UByte a, Vec3ub b) {
        return ArithmeticOperators.sub(res, b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub sub(Vec3ub res, byte a, Vec3ub b) {
        return ArithmeticOperators.sub(res, b, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec3ub sub(Vec3ub res, UByte aX, UByte aY, UByte aZ, Vec3ub b) {
        return ArithmeticOperators.sub(res, b, aX.value & 0xff, aY.value & 0xff, aZ.value & 0xff);
    }

    public static Vec3ub sub(Vec3ub res, byte aX, byte aY, byte aZ, Vec3ub b) {
        return ArithmeticOperators.sub(res, b, aX & 0xff, aY & 0xff, aZ & 0xff);
    }
    ...
    public static Vec3ui sub_(UInt a, Vec3ui b) {
        return ArithmeticOperators.sub(new Vec3ui(), b, a.value, a.value, a.value);
    }

    public static Vec3ui sub_(int a, Vec3ui b) {
        return ArithmeticOperators.sub(new Vec3ui(), b, a, a, a);
    }

    public static Vec3ui sub(UInt a, Vec3ui b) {
        return ArithmeticOperators.sub(b, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui sub(Vec3ui res, UInt a, Vec3ui b) {
        return ArithmeticOperators.sub(res, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui sub(Vec3ui res, UInt aX, UInt aY, UInt aZ, Vec3ui b) {
        return ArithmeticOperators.sub(res, b, aX.value, aY.value, aZ.value);
    }
    ...
    public static Vec3ul sub_(ULong a, Vec3ul b) {
        return ArithmeticOperators.sub(new Vec3ul(), b, a.value, a.value, a.value);
    }

    public static Vec3ul sub_(long a, Vec3ul b) {
        return ArithmeticOperators.sub(new Vec3ul(), b, a, a, a);
    }
    ...
    public static Vec3us sub_(UShort a, Vec3us b) {
        return ArithmeticOperators.sub(new Vec3us(), b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us sub_(short a, Vec3us b) {
        return ArithmeticOperators.sub(new Vec3us(), b, a & 0xffff, a & 0xffff, a & 0xffff);
    }

    public static Vec3us sub_(int a, Vec3us b) {
        return ArithmeticOperators.sub(new Vec3us(), b, a, a, a);
    }

    public static Vec3us sub(UShort a, Vec3us b) {
        return ArithmeticOperators.sub(b, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us sub(short a, Vec3us b) {
        return ArithmeticOperators.sub(b, b, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec3us sub(Vec3us res, UShort a, Vec3us b) {
        return ArithmeticOperators.sub(res, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us sub(Vec3us res, short a, Vec3us b) {
        return ArithmeticOperators.sub(res, b, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec3us sub(Vec3us res, UShort aX, UShort aY, UShort aZ, Vec3us b) {
        return ArithmeticOperators.sub(res, b, aX.value & 0xffff, aY.value & 0xffff, aZ.value & 0xffff);
    }

    public static Vec3us sub(Vec3us res, short aX, short aY, short aZ, Vec3us b) {
        return ArithmeticOperators.sub(res, b, aX & 0xffff, aY & 0xffff, aZ & 0xffff);
    }
    ...
    public static Vec4 sub_(float a, Vec4 b) {
        return ArithmeticOperators.sub(new Vec4(), b, a, a, a, a);
    }

    public static Vec4 sub(float a, Vec4 b) {
        return ArithmeticOperators.sub(b, b, a, a, a, a);
    }

    public static Vec4 sub(Vec4 res, float a, Vec4 b) {
        return ArithmeticOperators.sub(res, b, a, a, a, a);
    }

    public static Vec4 sub(Vec4 res, float aX, float aY, float aZ, float aW, Vec4 b) {
        return ArithmeticOperators.sub(res, b, aX, aY, aZ, aW);
    }

    public static Vec4b sub_(byte a, Vec4b b) {
        return ArithmeticOperators.sub(new Vec4b(), b, (int) a, a, a, a);
    }

    public static Vec4b sub_(int a, Vec4b b) {
        return ArithmeticOperators.sub(new Vec4b(), b, a, a, a, a);
    }

    public static Vec4b sub(byte a, Vec4b b) {
        return ArithmeticOperators.sub(b, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b sub(Vec4b res, byte a, Vec4b b) {
        return ArithmeticOperators.sub(res, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b sub(Vec4b res, byte aX, byte aY, byte aZ, byte aW, Vec4b b) {
        return ArithmeticOperators.sub(res, b, (int) aX, aY, aZ, aW);
    }
    ...
    public static Vec4d sub_(double a, Vec4d b) {
        return ArithmeticOperators.sub(new Vec4d(), b, a, a, a, a);
    }
    ...
    public static Vec4i sub_(int a, Vec4i b) {
        return ArithmeticOperators.sub(new Vec4i(), b, a, a, a, a);
    }
    ...
    public static Vec4l sub_(long a, Vec4l b) {
        return ArithmeticOperators.sub(new Vec4l(), b, a, a, a, a);
    }
    ...
    public static Vec4s sub_(short a, Vec4s b) {
        return ArithmeticOperators.sub(new Vec4s(), b, a, a, a, a);
    }
    ...
    public static Vec4ub sub_(UByte a, Vec4ub b) {
        return ArithmeticOperators.sub(new Vec4ub(), b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub sub_(byte a, Vec4ub b) {
        return ArithmeticOperators.sub(new Vec4ub(), b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }

    public static Vec4ub sub_(int a, Vec4ub b) {
        return ArithmeticOperators.sub(new Vec4ub(), b, a, a, a, a);
    }

    public static Vec4ub sub(UByte a, Vec4ub b) {
        return ArithmeticOperators.sub(b, b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub sub(byte a, Vec4ub b) {
        return ArithmeticOperators.sub(b, b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec4ub sub(Vec4ub res, UByte a, Vec4ub b) {
        return ArithmeticOperators.sub(res, b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub sub(Vec4ub res, byte a, Vec4ub b) {
        return ArithmeticOperators.sub(res, b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec4ub sub(Vec4ub res, UByte aX, UByte aY, UByte aZ, UByte aW, Vec4ub b) {
        return ArithmeticOperators.sub(res, b, aX.value & 0xff, aY.value & 0xff, aZ.value & 0xff, aW.value & 0xff);
    }

    public static Vec4ub sub(Vec4ub res, byte aX, byte aY, byte aZ, byte aW, Vec4ub b) {
        return ArithmeticOperators.sub(res, b, aX & 0xff, aY & 0xff, aZ & 0xff, aW & 0xff);
    }
    ...
    public static Vec4ui sub_(UInt a, Vec4ui b) {
        return ArithmeticOperators.sub(new Vec4ui(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ui sub_(int a, Vec4ui b) {
        return ArithmeticOperators.sub(new Vec4ui(), b, a, a, a, a);
    }

    public static Vec4ui sub(UInt a, Vec4ui b) {
        return ArithmeticOperators.sub(b, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui sub(Vec4ui res, UInt a, Vec4ui b) {
        return ArithmeticOperators.sub(res, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui sub(Vec4ui res, UInt aX, UInt aY, UInt aZ, UInt aW, Vec4ui b) {
        return ArithmeticOperators.sub(res, b, aX.value, aY.value, aZ.value, aW.value);
    }
    ...
    public static Vec4ul sub_(ULong a, Vec4ul b) {
        return ArithmeticOperators.sub(new Vec4ul(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ul sub_(long a, Vec4ul b) {
        return ArithmeticOperators.sub(new Vec4ul(), b, a, a, a, a);
    }
    ...
    public static Vec4us sub_(UShort a, Vec4us b) {
        return ArithmeticOperators.sub(new Vec4us(), b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us sub_(short a, Vec4us b) {
        return ArithmeticOperators.sub(new Vec4us(), b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }

    public static Vec4us sub_(int a, Vec4us b) {
        return ArithmeticOperators.sub(new Vec4us(), b, a, a, a, a);
    }

    public static Vec4us sub(UShort a, Vec4us b) {
        return ArithmeticOperators.sub(b, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us sub(short a, Vec4us b) {
        return ArithmeticOperators.sub(b, b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec4us sub(Vec4us res, UShort a, Vec4us b) {
        return ArithmeticOperators.sub(res, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us sub(Vec4us res, short a, Vec4us b) {
        return ArithmeticOperators.sub(res, b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec4us sub(Vec4us res, UShort aX, UShort aY, UShort aZ, UShort aW, Vec4us b) {
        return ArithmeticOperators.sub(res, b, aX.value & 0xffff, aY.value & 0xffff, aZ.value & 0xffff, aW.value & 0xffff);
    }

    public static Vec4us sub(Vec4us res, short aX, short aY, short aZ, short aW, Vec4us b) {
        return ArithmeticOperators.sub(res, b, aX & 0xffff, aY & 0xffff, aZ & 0xffff, aW & 0xffff);
    }
    ...
    public static Vec2 mul_(float a, Vec2 b) {
        return ArithmeticOperators.mul(new Vec2(), b, a, a);
    }

    public static Vec2 mul(float a, Vec2 b) {
        return ArithmeticOperators.mul(b, b, a, a);
    }

    public static Vec2 mul(Vec2 res, float a, Vec2 b) {
        return ArithmeticOperators.mul(res, b, a, a);
    }

    public static Vec2 mul(Vec2 res, float aX, float aY, Vec2 b) {
        return ArithmeticOperators.mul(res, b, aX, aY);
    }

    public static Vec2b mul_(byte a, Vec2b b) {
        return ArithmeticOperators.mul(new Vec2b(), b, (int) a, a);
    }

    public static Vec2b mul_(int a, Vec2b b) {
        return ArithmeticOperators.mul(new Vec2b(), b, a, a);
    }

    public static Vec2b mul(byte a, Vec2b b) {
        return ArithmeticOperators.mul(b, b, (int) a, a);
    }
    ...
    public static Vec2b mul(Vec2b res, byte a, Vec2b b) {
        return ArithmeticOperators.mul(res, b, (int) a, a);
    }
    ...
    public static Vec2b mul(Vec2b res, byte aX, byte aY, Vec2b b) {
        return ArithmeticOperators.mul(res, b, (int) aX, aY);
    }
    ...
    public static Vec2d mul_(double a, Vec2d b) {
        return ArithmeticOperators.mul(new Vec2d(), b, a, a);
    }
    ...
    public static Vec2i mul_(int a, Vec2i b) {
        return ArithmeticOperators.mul(new Vec2i(), b, a, a);
    }
    ...
    public static Vec2l mul_(long a, Vec2l b) {
        return ArithmeticOperators.mul(new Vec2l(), b, a, a);
    }
    ...
    public static Vec2s mul_(short a, Vec2s b) {
        return ArithmeticOperators.mul(new Vec2s(), b, a, a);
    }
    ...
    public static Vec2ub mul_(UByte a, Vec2ub b) {
        return ArithmeticOperators.mul(new Vec2ub(), b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub mul_(byte a, Vec2ub b) {
        return ArithmeticOperators.mul(new Vec2ub(), b, a & 0xff, a & 0xff);
    }

    public static Vec2ub mul_(int a, Vec2ub b) {
        return ArithmeticOperators.mul(new Vec2ub(), b, a, a);
    }

    public static Vec2ub mul(UByte a, Vec2ub b) {
        return ArithmeticOperators.mul(b, b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub mul(byte a, Vec2ub b) {
        return ArithmeticOperators.mul(b, b, a & 0xff, a & 0xff);
    }
    ...
    public static Vec2ub mul(Vec2ub res, UByte a, Vec2ub b) {
        return ArithmeticOperators.mul(res, b, a.value & 0xff, a.value & 0xff);
    }

    public static Vec2ub mul(Vec2ub res, byte a, Vec2ub b) {
        return ArithmeticOperators.mul(res, b, a & 0xff, a & 0xff);
    }
    ...
    public static Vec2ub mul(Vec2ub res, UByte aX, UByte aY, Vec2ub b) {
        return ArithmeticOperators.mul(res, b, aX.value & 0xff, aY.value & 0xff);
    }

    public static Vec2ub mul(Vec2ub res, byte aX, byte aY, Vec2ub b) {
        return ArithmeticOperators.mul(res, b, aX & 0xff, aY & 0xff);
    }
    ...
    public static Vec2ui mul_(UInt a, Vec2ui b) {
        return ArithmeticOperators.mul(new Vec2ui(), b, a.value, a.value);
    }

    public static Vec2ui mul_(int a, Vec2ui b) {
        return ArithmeticOperators.mul(new Vec2ui(), b, a, a);
    }

    public static Vec2ui mul(UInt a, Vec2ui b) {
        return ArithmeticOperators.mul(b, b, a.value, a.value);
    }
    ...
    public static Vec2ui mul(Vec2ui res, UInt a, Vec2ui b) {
        return ArithmeticOperators.mul(res, b, a.value, a.value);
    }
    ...
    public static Vec2ui mul(Vec2ui res, UInt aX, UInt aY, Vec2ui b) {
        return ArithmeticOperators.mul(res, b, aX.value, aY.value);
    }
    ...
    public static Vec2ul mul_(ULong a, Vec2ul b) {
        return ArithmeticOperators.mul(new Vec2ul(), b, a.value, a.value);
    }

    public static Vec2ul mul_(long a, Vec2ul b) {
        return ArithmeticOperators.mul(new Vec2ul(), b, a, a);
    }
    ...
    public static Vec2us mul_(UShort a, Vec2us b) {
        return ArithmeticOperators.mul(new Vec2us(), b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us mul_(short a, Vec2us b) {
        return ArithmeticOperators.mul(new Vec2us(), b, a & 0xffff, a & 0xffff);
    }

    public static Vec2us mul_(int a, Vec2us b) {
        return ArithmeticOperators.mul(new Vec2us(), b, a, a);
    }

    public static Vec2us mul(UShort a, Vec2us b) {
        return ArithmeticOperators.mul(b, b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us mul(short a, Vec2us b) {
        return ArithmeticOperators.mul(b, b, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec2us mul(Vec2us res, UShort a, Vec2us b) {
        return ArithmeticOperators.mul(res, b, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec2us mul(Vec2us res, short a, Vec2us b) {
        return ArithmeticOperators.mul(res, b, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec2us mul(Vec2us res, UShort aX, UShort aY, Vec2us b) {
        return ArithmeticOperators.mul(res, b, aX.value & 0xffff, aY.value & 0xffff);
    }

    public static Vec2us mul(Vec2us res, short aX, short aY, Vec2us b) {
        return ArithmeticOperators.mul(res, b, aX & 0xffff, aY & 0xffff);
    }
    ...
    public static Vec3 mul_(float a, Vec3 b) {
        return ArithmeticOperators.mul(new Vec3(), b, a, a, a);
    }

    public static Vec3 mul(float a, Vec3 b) {
        return ArithmeticOperators.mul(b, b, a, a, a);
    }

    public static Vec3 mul(Vec3 res, float a, Vec3 b) {
        return ArithmeticOperators.mul(res, b, a, a, a);
    }

    public static Vec3 mul(Vec3 res, float aX, float aY, float aZ, Vec3 b) {
        return ArithmeticOperators.mul(res, b, aX, aY, aZ);
    }

    public static Vec3b mul_(byte a, Vec3b b) {
        return ArithmeticOperators.mul(new Vec3b(), b, (int) a, a, a);
    }

    public static Vec3b mul_(int a, Vec3b b) {
        return ArithmeticOperators.mul(new Vec3b(), b, a, a, a);
    }

    public static Vec3b mul(byte a, Vec3b b) {
        return ArithmeticOperators.mul(b, b, (int) a, a, a);
    }
    ...
    public static Vec3b mul(Vec3b res, byte a, Vec3b b) {
        return ArithmeticOperators.mul(res, b, (int) a, a, a);
    }
    ...
    public static Vec3b mul(Vec3b res, byte aX, byte aY, byte aZ, Vec3b b) {
        return ArithmeticOperators.mul(res, b, (int) aX, aY, aZ);
    }
    ...
    public static Vec3d mul_(double a, Vec3d b) {
        return ArithmeticOperators.mul(new Vec3d(), b, a, a, a);
    }
    ...
    public static Vec3i mul_(int a, Vec3i b) {
        return ArithmeticOperators.mul(new Vec3i(), b, a, a, a);
    }
    ...
    public static Vec3l mul_(long a, Vec3l b) {
        return ArithmeticOperators.mul(new Vec3l(), b, a, a, a);
    }
    ...
    public static Vec3s mul_(short a, Vec3s b) {
        return ArithmeticOperators.mul(new Vec3s(), b, a, a, a);
    }
    ...
    public static Vec3ub mul_(UByte a, Vec3ub b) {
        return ArithmeticOperators.mul(new Vec3ub(), b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub mul_(byte a, Vec3ub b) {
        return ArithmeticOperators.mul(new Vec3ub(), b, a & 0xff, a & 0xff, a & 0xff);
    }

    public static Vec3ub mul_(int a, Vec3ub b) {
        return ArithmeticOperators.mul(new Vec3ub(), b, a, a, a);
    }

    public static Vec3ub mul(UByte a, Vec3ub b) {
        return ArithmeticOperators.mul(b, b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub mul(byte a, Vec3ub b) {
        return ArithmeticOperators.mul(b, b, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec3ub mul(Vec3ub res, UByte a, Vec3ub b) {
        return ArithmeticOperators.mul(res, b, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec3ub mul(Vec3ub res, byte a, Vec3ub b) {
        return ArithmeticOperators.mul(res, b, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec3ub mul(Vec3ub res, UByte aX, UByte aY, UByte aZ, Vec3ub b) {
        return ArithmeticOperators.mul(res, b, aX.value & 0xff, aY.value & 0xff, aZ.value & 0xff);
    }

    public static Vec3ub mul(Vec3ub res, byte aX, byte aY, byte aZ, Vec3ub b) {
        return ArithmeticOperators.mul(res, b, aX & 0xff, aY & 0xff, aZ & 0xff);
    }
    ...
    public static Vec3ui mul_(UInt a, Vec3ui b) {
        return ArithmeticOperators.mul(new Vec3ui(), b, a.value, a.value, a.value);
    }

    public static Vec3ui mul_(int a, Vec3ui b) {
        return ArithmeticOperators.mul(new Vec3ui(), b, a, a, a);
    }

    public static Vec3ui mul(UInt a, Vec3ui b) {
        return ArithmeticOperators.mul(b, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui mul(Vec3ui res, UInt a, Vec3ui b) {
        return ArithmeticOperators.mul(res, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui mul(Vec3ui res, UInt aX, UInt aY, UInt aZ, Vec3ui b) {
        return ArithmeticOperators.mul(res, b, aX.value, aY.value, aZ.value);
    }
    ...
    public static Vec3ul mul_(ULong a, Vec3ul b) {
        return ArithmeticOperators.mul(new Vec3ul(), b, a.value, a.value, a.value);
    }

    public static Vec3ul mul_(long a, Vec3ul b) {
        return ArithmeticOperators.mul(new Vec3ul(), b, a, a, a);
    }
    ...
    public static Vec3us mul_(UShort a, Vec3us b) {
        return ArithmeticOperators.mul(new Vec3us(), b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us mul_(short a, Vec3us b) {
        return ArithmeticOperators.mul(new Vec3us(), b, a & 0xffff, a & 0xffff, a & 0xffff);
    }

    public static Vec3us mul_(int a, Vec3us b) {
        return ArithmeticOperators.mul(new Vec3us(), b, a, a, a);
    }

    public static Vec3us mul(UShort a, Vec3us b) {
        return ArithmeticOperators.mul(b, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us mul(short a, Vec3us b) {
        return ArithmeticOperators.mul(b, b, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec3us mul(Vec3us res, UShort a, Vec3us b) {
        return ArithmeticOperators.mul(res, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec3us mul(Vec3us res, short a, Vec3us b) {
        return ArithmeticOperators.mul(res, b, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec3us mul(Vec3us res, UShort aX, UShort aY, UShort aZ, Vec3us b) {
        return ArithmeticOperators.mul(res, b, aX.value & 0xffff, aY.value & 0xffff, aZ.value & 0xffff);
    }

    public static Vec3us mul(Vec3us res, short aX, short aY, short aZ, Vec3us b) {
        return ArithmeticOperators.mul(res, b, aX & 0xffff, aY & 0xffff, aZ & 0xffff);
    }
    ...
    public static Vec4 mul_(float a, Vec4 b) {
        return ArithmeticOperators.mul(new Vec4(), b, a, a, a, a);
    }

    public static Vec4 mul(float a, Vec4 b) {
        return ArithmeticOperators.mul(b, b, a, a, a, a);
    }

    public static Vec4 mul(Vec4 res, float a, Vec4 b) {
        return ArithmeticOperators.mul(res, b, a, a, a, a);
    }

    public static Vec4 mul(Vec4 res, float aX, float aY, float aZ, float aW, Vec4 b) {
        return ArithmeticOperators.mul(res, b, aX, aY, aZ, aW);
    }

    public static Vec4b mul_(byte a, Vec4b b) {
        return ArithmeticOperators.mul(new Vec4b(), b, (int) a, a, a, a);
    }

    public static Vec4b mul_(int a, Vec4b b) {
        return ArithmeticOperators.mul(new Vec4b(), b, a, a, a, a);
    }

    public static Vec4b mul(byte a, Vec4b b) {
        return ArithmeticOperators.mul(b, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b mul(Vec4b res, byte a, Vec4b b) {
        return ArithmeticOperators.mul(res, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b mul(Vec4b res, byte aX, byte aY, byte aZ, byte aW, Vec4b b) {
        return ArithmeticOperators.mul(res, b, (int) aX, aY, aZ, aW);
    }
    ...
    public static Vec4d mul_(double a, Vec4d b) {
        return ArithmeticOperators.mul(new Vec4d(), b, a, a, a, a);
    }
    ...
    public static Vec4i mul_(int a, Vec4i b) {
        return ArithmeticOperators.mul(new Vec4i(), b, a, a, a, a);
    }
    ...
    public static Vec4l mul_(long a, Vec4l b) {
        return ArithmeticOperators.mul(new Vec4l(), b, a, a, a, a);
    }
    ...
    public static Vec4s mul_(short a, Vec4s b) {
        return ArithmeticOperators.mul(new Vec4s(), b, a, a, a, a);
    }
    ...
    public static Vec4ub mul_(UByte a, Vec4ub b) {
        return ArithmeticOperators.mul(new Vec4ub(), b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub mul_(byte a, Vec4ub b) {
        return ArithmeticOperators.mul(new Vec4ub(), b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }

    public static Vec4ub mul_(int a, Vec4ub b) {
        return ArithmeticOperators.mul(new Vec4ub(), b, a, a, a, a);
    }

    public static Vec4ub mul(UByte a, Vec4ub b) {
        return ArithmeticOperators.mul(b, b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub mul(byte a, Vec4ub b) {
        return ArithmeticOperators.mul(b, b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec4ub mul(Vec4ub res, UByte a, Vec4ub b) {
        return ArithmeticOperators.mul(res, b, a.value & 0xff, a.value & 0xff, a.value & 0xff, a.value & 0xff);
    }

    public static Vec4ub mul(Vec4ub res, byte a, Vec4ub b) {
        return ArithmeticOperators.mul(res, b, a & 0xff, a & 0xff, a & 0xff, a & 0xff);
    }
    ...
    public static Vec4ub mul(Vec4ub res, UByte aX, UByte aY, UByte aZ, UByte aW, Vec4ub b) {
        return ArithmeticOperators.mul(res, b, aX.value & 0xff, aY.value & 0xff, aZ.value & 0xff, aW.value & 0xff);
    }

    public static Vec4ub mul(Vec4ub res, byte aX, byte aY, byte aZ, byte aW, Vec4ub b) {
        return ArithmeticOperators.mul(res, b, aX & 0xff, aY & 0xff, aZ & 0xff, aW & 0xff);
    }
    ...
    public static Vec4ui mul_(UInt a, Vec4ui b) {
        return ArithmeticOperators.mul(new Vec4ui(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ui mul_(int a, Vec4ui b) {
        return ArithmeticOperators.mul(new Vec4ui(), b, a, a, a, a);
    }

    public static Vec4ui mul(UInt a, Vec4ui b) {
        return ArithmeticOperators.mul(b, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui mul(Vec4ui res, UInt a, Vec4ui b) {
        return ArithmeticOperators.mul(res, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui mul(Vec4ui res, UInt aX, UInt aY, UInt aZ, UInt aW, Vec4ui b) {
        return ArithmeticOperators.mul(res, b, aX.value, aY.value, aZ.value, aW.value);
    }
    ...
    public static Vec4ul mul_(ULong a, Vec4ul b) {
        return ArithmeticOperators.mul(new Vec4ul(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ul mul_(long a, Vec4ul b) {
        return ArithmeticOperators.mul(new Vec4ul(), b, a, a, a, a);
    }
    ...
    public static Vec4us mul_(UShort a, Vec4us b) {
        return ArithmeticOperators.mul(new Vec4us(), b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us mul_(short a, Vec4us b) {
        return ArithmeticOperators.mul(new Vec4us(), b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }

    public static Vec4us mul_(int a, Vec4us b) {
        return ArithmeticOperators.mul(new Vec4us(), b, a, a, a, a);
    }

    public static Vec4us mul(UShort a, Vec4us b) {
        return ArithmeticOperators.mul(b, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us mul(short a, Vec4us b) {
        return ArithmeticOperators.mul(b, b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec4us mul(Vec4us res, UShort a, Vec4us b) {
        return ArithmeticOperators.mul(res, b, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff, a.value & 0xffff);
    }

    public static Vec4us mul(Vec4us res, short a, Vec4us b) {
        return ArithmeticOperators.mul(res, b, a & 0xffff, a & 0xffff, a & 0xffff, a & 0xffff);
    }
    ...
    public static Vec4us mul(Vec4us res, UShort aX, UShort aY, UShort aZ, UShort aW, Vec4us b) {
        return ArithmeticOperators.mul(res, b, aX.value & 0xffff, aY.value & 0xffff, aZ.value & 0xffff, aW.value & 0xffff);
    }

    public static Vec4us mul(Vec4us res, short aX, short aY, short aZ, short aW, Vec4us b) {
        return ArithmeticOperators.mul(res, b, aX & 0xffff, aY & 0xffff, aZ & 0xffff, aW & 0xffff);
    }
    ...
    public static Vec3 div_(float a, Vec3 b) {
        return ArithmeticOperators.div(new Vec3(), b, a, a, a);
    }

    public static Vec3 div(float a, Vec3 b) {
        return ArithmeticOperators.div(b, b, a, a, a);
    }

    public static Vec3 div(Vec3 res, float a, Vec3 b) {
        return ArithmeticOperators.div(res, b, a, a, a);
    }

    public static Vec3 div(Vec3 res, float aX, float aY, float aZ, Vec3 b) {
        return ArithmeticOperators.div(res, b, aX, aY, aZ);
    }

    public static Vec3b div_(byte a, Vec3b b) {
        return ArithmeticOperators.div(new Vec3b(), b, (int) a, a, a);
    }

    public static Vec3b div_(int a, Vec3b b) {
        return ArithmeticOperators.div(new Vec3b(), b, a, a, a);
    }

    public static Vec3b div(byte a, Vec3b b) {
        return ArithmeticOperators.div(b, b, (int) a, a, a);
    }
    ...
    public static Vec3b div(Vec3b res, byte a, Vec3b b) {
        return ArithmeticOperators.div(res, b, (int) a, a, a);
    }
    ...
    public static Vec3b div(Vec3b res, byte aX, byte aY, byte aZ, Vec3b b) {
        return ArithmeticOperators.div(res, b, (int) aX, aY, aZ);
    }
    ...
    public static Vec3d div_(double a, Vec3d b) {
        return ArithmeticOperators.div(new Vec3d(), b, a, a, a);
    }
    ...
    public static Vec3i div_(int a, Vec3i b) {
        return ArithmeticOperators.div(new Vec3i(), b, a, a, a);
    }
    ...
    public static Vec3l div_(long a, Vec3l b) {
        return ArithmeticOperators.div(new Vec3l(), b, a, a, a);
    }
    ...
    public static Vec3s div_(short a, Vec3s b) {
        return ArithmeticOperators.div(new Vec3s(), b, a, a, a);
    }
    ...
    public static Vec3ui div_(UInt a, Vec3ui b) {
        return ArithmeticOperators.div(new Vec3ui(), b, a.value, a.value, a.value);
    }

    public static Vec3ui div_(int a, Vec3ui b) {
        return ArithmeticOperators.div(new Vec3ui(), b, a, a, a);
    }

    public static Vec3ui div(UInt a, Vec3ui b) {
        return ArithmeticOperators.div(b, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui div(Vec3ui res, UInt a, Vec3ui b) {
        return ArithmeticOperators.div(res, b, a.value, a.value, a.value);
    }
    ...
    public static Vec3ui div(Vec3ui res, UInt aX, UInt aY, UInt aZ, Vec3ui b) {
        return ArithmeticOperators.div(res, b, aX.value, aY.value, aZ.value);
    }
    ...
    public static Vec3ul div_(ULong a, Vec3ul b) {
        return ArithmeticOperators.div(new Vec3ul(), b, a.value, a.value, a.value);
    }

    public static Vec3ul div_(long a, Vec3ul b) {
        return ArithmeticOperators.div(new Vec3ul(), b, a, a, a);
    }
    ...
    public static Vec4 div_(float a, Vec4 b) {
        return ArithmeticOperators.div(new Vec4(), b, a, a, a, a);
    }

    public static Vec4 div(float a, Vec4 b) {
        return ArithmeticOperators.div(b, b, a, a, a, a);
    }

    public static Vec4 div(Vec4 res, float a, Vec4 b) {
        return ArithmeticOperators.div(res, b, a, a, a, a);
    }

    public static Vec4 div(Vec4 res, float aX, float aY, float aZ, float aW, Vec4 b) {
        return ArithmeticOperators.div(res, b, aX, aY, aZ, aW);
    }

    public static Vec4b div_(byte a, Vec4b b) {
        return ArithmeticOperators.div(new Vec4b(), b, (int) a, a, a, a);
    }

    public static Vec4b div_(int a, Vec4b b) {
        return ArithmeticOperators.div(new Vec4b(), b, a, a, a, a);
    }

    public static Vec4b div(byte a, Vec4b b) {
        return ArithmeticOperators.div(b, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b div(Vec4b res, byte a, Vec4b b) {
        return ArithmeticOperators.div(res, b, (int) a, a, a, a);
    }
    ...
    public static Vec4b div(Vec4b res, byte aX, byte aY, byte aZ, byte aW, Vec4b b) {
        return ArithmeticOperators.div(res, b, (int) aX, aY, aZ, aW);
    }
    ...
    public static Vec4d div_(double a, Vec4d b) {
        return ArithmeticOperators.div(new Vec4d(), b, a, a, a, a);
    }
    ...
    public static Vec4i div_(int a, Vec4i b) {
        return ArithmeticOperators.div(new Vec4i(), b, a, a, a, a);
    }
    ...
    public static Vec4l div_(long a, Vec4l b) {
        return ArithmeticOperators.div(new Vec4l(), b, a, a, a, a);
    }
    ...
    public static Vec4s div_(short a, Vec4s b) {
        return ArithmeticOperators.div(new Vec4s(), b, a, a, a, a);
    }
    ...
    public static Vec4ui div_(UInt a, Vec4ui b) {
        return ArithmeticOperators.div(new Vec4ui(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ui div_(int a, Vec4ui b) {
        return ArithmeticOperators.div(new Vec4ui(), b, a, a, a, a);
    }

    public static Vec4ui div(UInt a, Vec4ui b) {
        return ArithmeticOperators.div(b, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui div(Vec4ui res, UInt a, Vec4ui b) {
        return ArithmeticOperators.div(res, b, a.value, a.value, a.value, a.value);
    }
    ...
    public static Vec4ui div(Vec4ui res, UInt aX, UInt aY, UInt aZ, UInt aW, Vec4ui b) {
        return ArithmeticOperators.div(res, b, aX.value, aY.value, aZ.value, aW.value);
    }
    ...
    public static Vec4ul div_(ULong a, Vec4ul b) {
        return ArithmeticOperators.div(new Vec4ul(), b, a.value, a.value, a.value, a.value);
    }

    public static Vec4ul div_(long a, Vec4ul b) {
        return ArithmeticOperators.div(new Vec4ul(), b, a, a, a, a);
    }
